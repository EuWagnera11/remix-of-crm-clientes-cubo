...
const PAGES: SearchResult[] = [
  ...
  { id: "patients", label: "Pacientes / Leads", type: "page", url: "/patients", icon: Users },
  { id: "agenda", label: "Agenda", type: "page", url: "/agenda", icon: Calendar },
  ...
  { id: "procedures", label: "Procedimentos", type: "page", url: "/procedures", icon: Package },
  ...
  { id: "nps", label: "NPS e Satisfação", type: "page", url: "/nps", icon: Star },
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="p-0 gap-0 max-w-lg overflow-hidden">
        ...
        <div className="max-h-[350px] overflow-y-auto p-2">
          {patients.length > 0 && (
            <>
              <p className="px-2 py-1.5 text-[10px] uppercase tracking-wider text-muted-foreground font-medium">Pacientes</p>
              {patients.map((r, i) => {
