    ...
    <div className="flex h-screen w-full overflow-hidden bg-background">
      <aside className="flex w-60 flex-col border-r border-border bg-card">
        ...
        <div className="flex-1 px-2 py-3">
          <Button variant="ghost" className="w-full justify-start gap-2 text-muted-foreground" onClick={() => navigate("/admin")}><ChevronLeft className="h-4 w-4" />Voltar para Clínicas</Button>
        </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-14 items-center justify-between border-b border-border bg-card px-6">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <Link to="/admin" className="hover:text-foreground">Clínicas</Link><span>/</span>
